...
from higcbf.utils.typing import Action, Array, Params, PRNGKey, State
from higcbf.utils.utils import mask2index, jax_vmap
...
class DecShareCBF(MultiAgentController):
    ...
    def __init__(
        ...
        self.k = 3 # number of closest agents/obstacles to consider
    ...
    def get_qp_action(self, graph: GraphsTuple, relax_penalty: float = 1e3) -> [Action, Array]:
        ...
        ak_hx = jax.jacfwd(h)(agent_state) # Jacobian of h(x)
